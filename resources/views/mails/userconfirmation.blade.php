...
<table class="head-wrap" bgcolor="#234bbe">
    <tr>
        <td></td>
        <td class="header container">
            <div class="content">
                <h4><a href="http://trazoo.in/" target="_blank"
                       style="color: #fff; text-decoration: none; text-align: center;">OTFCoder</a></h4>
            </div>
        </td>
        <td></td>
    </tr>
...
<table class="body-wrap">
        ...
        <td class="container" bgcolor="#FFFFFF">
            <div class="content">
                <table>
                    <tr>
                        <td>
                            <h3 style="margin-bottom: 10px;">Hi <strong style="color: #234bbe;">{{ $first_name }}</strong></h3>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p><span style="width: 110px; display: inline-block; color: #000;">Link : </span>
                                                        <strong style=" color: #000;">{{ route('confirmation',$token) }}</strong></p>

                                                    <a href="tel:+9001635942" style="background: #234bbe;
    color: #fff;
    padding: 8px 25px;
    float: left;
    margin-top: 10px;
    ...
    font-size: 1.3rem;">Call to OTFCoder</a>
                                                </td>
                                            </tr>
                                        </table>
